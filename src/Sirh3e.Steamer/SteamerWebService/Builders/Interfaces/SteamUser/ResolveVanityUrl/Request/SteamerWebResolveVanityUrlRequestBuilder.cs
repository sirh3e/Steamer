...
namespace Sirh3e.Steamer.SteamerWebService.Builders.Interfaces.SteamUser.ResolveVanityUrl.Request
{
    ...
    {
        public SteamerWebResolveVanityUrlRequestBuilder(ISteamerInterface @interface) : base(@interface) => Request =
        ...
        public override ISteamerWebResolveVanityUrlRequest Build()
        {
            ...
            Request = new SteamerWebResolveVanityUrlRequest(Interface ?? throw new ArgumentNullException(nameof(Interface)));
