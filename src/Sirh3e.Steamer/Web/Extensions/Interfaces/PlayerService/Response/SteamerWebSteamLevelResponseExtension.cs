...
{
    public static class SteamerWebSteamLevelResponseExtension
    {
        public static ISteamerWebSteamLevelResponse RetryServiceExecute(this ISteamerWebSteamLevelResponse response,
