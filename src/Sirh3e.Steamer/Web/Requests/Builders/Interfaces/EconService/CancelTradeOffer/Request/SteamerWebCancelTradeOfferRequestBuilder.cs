...
{
    public class SteamerWebCancelTradeOfferRequestBuilder
        : SteamerRequestBuilder<SteamerWebCancelTradeOfferRequestBuilder, ISteamerWebCancelTradeOfferRequest>,
