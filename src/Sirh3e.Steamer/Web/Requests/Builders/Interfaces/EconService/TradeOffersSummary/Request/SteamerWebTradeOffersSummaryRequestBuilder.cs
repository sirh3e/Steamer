...
{
    public class SteamerWebTradeOffersSummaryRequestBuilder : SteamerRequestBuilder<SteamerWebTradeOffersSummaryRequestBuilder,
                                                            ISteamerWebTradeOffersSummaryRequest>,
